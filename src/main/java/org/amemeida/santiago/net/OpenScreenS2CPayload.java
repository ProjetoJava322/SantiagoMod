...
public record OpenScreenS2CPayload(int slot) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, OpenScreenS2CPayload> CODEC =
            PacketCodec.tuple(PacketCodecs.INTEGER, OpenScreenS2CPayload::slot, OpenScreenS2CPayload::new);
